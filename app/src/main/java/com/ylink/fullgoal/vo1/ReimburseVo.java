...
//    public final static String REIMBURSE_TYPE_EVECTION = "出差费用报销";
    ...
    public ReimburseVo(MessageBackFg fg, String serialNo) {
        if (fg != null) {
            ...
            setCostIndexFg(RunUtil.getFirstNonItem(fg.getCostIndextList()));
    ...
    public CostFg getCostIndexFg() {
        return costIndexFg;
    }

    public void setCostIndexFg(CostFg costIndexFg) {
        this.costIndexFg = costIndexFg;
    }

    public List<CostFg> getCostIndexData() {
