...
public class GridSpacingItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public GridSpacingItemDecoration(int mSpace, int mEdgeSpace) {
        this.mSpace = mSpace;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent,
        ...
        if (manager != null) {
            if (manager instanceof GridLayoutManager) {
                setGridOffset(((GridLayoutManager) manager).getOrientation(),
                        ((GridLayoutManager) manager).getSpanCount(), outRect, childPosition, itemCount);
            }
        }
    }
